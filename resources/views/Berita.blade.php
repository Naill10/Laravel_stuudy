<x-layout>
    <!-- Isi Halaman Beranda -->
  <body>
    <div class="bg-gray-900 py-24 sm:py-40">
    ...
    @foreach($posts as $post)
      <article class="flex max-w-xl flex-col items-start justify-between">
        <div class="flex items-center gap-x-4 text-xs">
          ...
          <a href="#" class="relative z-10 rounded-full bg-gray-800/60 px-3 py-1.5 font-medium text-gray-300 hover:bg-gray-800">{{ $post->posisi }}</a>
        </div>
        <div class="group relative grow">
          ...
          <p class="mt-5 line-clamp-3 text-sm/6 text-gray-400">{{ $post->isi_berita }}</p>
          </div>
